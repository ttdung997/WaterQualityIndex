...
for dictrict in dictrictArr:
    try:
        ...
        np.save('numpy/fuzzy_LSTM/'+ dictrict+"_label", test_set['TSI(Chl-a)'][-10:].values)
        np.save('numpy/fuzzy_LSTM/'+ dictrict+"_prediction", final_predict[-10:])
        ...
        # plt.savefig("rnn-fuzzy/"+ dictrict +'.png', dpi=100)
    #   # quit()
    except:
        continue
